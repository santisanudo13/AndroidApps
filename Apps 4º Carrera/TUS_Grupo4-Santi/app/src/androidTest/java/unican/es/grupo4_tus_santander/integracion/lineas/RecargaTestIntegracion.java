...
public class RecargaTestIntegracion extends InstrumentationTestCase {
    ...
    public void i1() {
        ...
        LineasActivity activity = mock(LineasActivity.class);

        //Realizamos la recarga de la base de datos
        RecargaBaseDatosLineas refresh = new RecargaBaseDatosLineas(InstrumentationRegistry.getTargetContext(), activity);

        refresh.setListener(new RecargaBaseDatosLineas.ServicioListener(){
            @Override
